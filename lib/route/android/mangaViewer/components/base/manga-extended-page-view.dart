...
import 'package:maxga/components/base/manga-page-view.dart';
...
class MangaExtendedPageView extends ExtendedImageGesturePageView {
  ...
  ExtendedImageGesturePageViewState createState() {
    return _MangaExtendedPageViewState();
  }
}
...
class _MangaExtendedPageViewState extends ExtendedImageGesturePageViewState
  ...
  Widget build(BuildContext context) {
    Widget result = MangaPageView.custom(
